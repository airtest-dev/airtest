...
module AirTest
  # Handles configuration for AirTest, including API tokens and environment variables.
  class Configuration
    attr_accessor :notion_token, :notion_database_id, :jira_token, :jira_project_id, :jira_domain, :jira_email, :monday_token, :monday_board_id, :monday_domain, :github_token, :repo, :tool
